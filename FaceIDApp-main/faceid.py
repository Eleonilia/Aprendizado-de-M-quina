...
"""
O Aplicativo tem três status para o rótulo de verificação
Verificação não iniciada: Estado inicial
Verificado: A pessoa corresponde
Não verificado: Sem correspondência
"""
...
class CamApp(App):
    ...
    def build(self):
        ...
        self.verification_label = Label(text="Verificação não iniciada", size_hint=(1,.1))
